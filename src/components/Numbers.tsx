...
export default function Numbers() {
  ...
  return (
    ...
    >
      ...
      {/* Center glow */}
      <div className="absolute top-1/2 left-1/2 hidden lg:block -translate-x-1/2 -translate-y-1/2 w-[800px] h-[400px] rounded-full opacity-[0.06]"
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-6">
          {stats.map((stat, i) => (
            <motion.div
              ...
              className="group relative glass rounded-2xl p-5 sm:p-8 border border-[#D4AF37]/15 hover:border-[#D4AF37]/40 text-center transition-all duration-400"
            ...
            >
              ...
              {/* Counter */}
              <div className="text-4xl sm:text-5xl font-black text-[#D4AF37] mb-2 font-body text-shadow-gold">
                {inView && (
                  <CountUp
                    start={0}
                    end={stat.value}
