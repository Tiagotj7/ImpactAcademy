...
export default function Founders() {
  ...
  return (
    <section id="fundadores" ref={ref} className="relative py-20 sm:py-28 overflow-hidden bg-[#050505]">
      <div className="absolute top-0 left-0 right-0 section-divider opacity-20" />

      <div className="absolute left-0 top-1/2 hidden lg:block -translate-y-1/2 w-64 h-64 rounded-full opacity-[0.05]"
        style={{ background: 'radial-gradient(circle, #D4AF37, transparent)' }}
      />
      <div className="absolute right-0 top-1/4 hidden lg:block w-48 h-48 rounded-full opacity-[0.04]"
        style={{ background: 'radial-gradient(circle, #D4AF37, transparent)' }}
      />
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 sm:gap-8 max-w-4xl mx-auto">
          {founders.map((founder, i) => (
            ...
            >
              ...
              <div className="relative p-6 sm:p-8 pb-6 text-center"
              ...
              >
                ...
                <div className="relative mx-auto w-24 h-24 sm:w-28 sm:h-28 mb-5">
                  ...
                  <div className="w-24 h-24 sm:w-28 sm:h-28 rounded-full border-2 border-[#D4AF37]/40 flex items-center justify-center mx-auto"
                    style={{ background: 'linear-gradient(135deg, rgba(212,175,55,0.15), rgba(212,175,55,0.05))' }}
                  >
                    <span className="gradient-text-gold font-black text-3xl sm:text-4xl font-body">{founder.initials}</span>
                  </div>
                ...
                <h3 className="text-white font-black text-xl sm:text-2xl mb-1 font-display">{founder.name}</h3>
